...
public class GuiHelperContainer extends GuiHelper {
    ...
    public GuiHelperContainer(Screen screen, int xSize, int ySize, int xInv, int yInv, String backgroundName) {
        super(screen, xSize, ySize, backgroundName);
        this.xInv = xInv;
        this.yInv = yInv;
    }

    public GuiHelperContainer(Screen screen, int xSize, int ySize, int xInv, int yInv) {
